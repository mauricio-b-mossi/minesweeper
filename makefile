...
link: out/main.o out/AssetManager.o out/Game.o out/StateManager.o
	g++ out/main.o out/AssetManager.o out/Game.o out/StateManager.o -o sfml-app -LC:/SFMLmingw6.1.0/lib -lsfml-graphics -lsfml-window -lsfml-system
